...
module Repeater_7(
  ...
  input  [2:0]   io_enq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [2:0]   io_deq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  always @(posedge clock) begin
    if (reset)
      full <= 1'h0;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14, :19:21]
    else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM[3'h0][13:11];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM[3'h0][31:14], _RANDOM[3'h1][13:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[3'h1][29:14];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_data = {_RANDOM[3'h1][31:30], _RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4], _RANDOM[3'h5][29:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
