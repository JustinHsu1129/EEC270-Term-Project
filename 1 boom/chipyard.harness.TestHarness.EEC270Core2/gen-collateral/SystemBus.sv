...
module SystemBus(
  ...
  input  [7:0]  auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_mask,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  input  [63:0] auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output [3:0]  auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  input  [63:0] auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output [2:0]  auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_sink,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output [63:0] auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  output        auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_boom_tile_tl_master_clock_xing_in_e_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  input  [2:0]  auto_coupler_from_boom_tile_tl_master_clock_xing_in_e_bits_sink,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output [1:0]  auto_coupler_from_rockettile_tl_master_clock_xing_in_b_bits_param,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_rockettile_tl_master_clock_xing_in_b_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output        auto_coupler_from_rockettile_tl_master_clock_xing_in_d_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_coupler_from_rockettile_tl_master_clock_xing_in_e_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output        auto_fixedClockNode_out_2_clock,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
                auto_fixedClockNode_out_2_reset,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  wire [3:0]  _fixer_auto_out_2_a_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
  ...
  wire [3:0]  _fixer_auto_out_2_c_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
  ...
  wire [3:0]  _system_bus_xbar_auto_in_2_b_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
  ...
  wire [3:0]  _system_bus_xbar_auto_in_2_d_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
  ...
  wire [1:0]  _system_bus_xbar_auto_in_1_b_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:40:43]
  ...
  TLFIFOFixer fixer (	// @[generators/rocket-chip/src/main/scala/tilelink/FIFOFixer.scala:146:27]
    .clock                     (_fixedClockNode_auto_out_0_clock),	// @[generators/rocket-chip/src/main/scala/prci/ClockGroup.scala:110:114]
    .reset                     (_fixedClockNode_auto_out_0_reset),	// @[generators/rocket-chip/src/main/scala/prci/ClockGroup.scala:110:114]
    .auto_in_2_a_ready         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_ready),
    .auto_in_2_a_valid         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_valid),
    .auto_in_2_a_bits_opcode   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_opcode),
    .auto_in_2_a_bits_param    (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_param),
    .auto_in_2_a_bits_size     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_size),
    .auto_in_2_a_bits_source   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_source),
    .auto_in_2_a_bits_address  (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_address),
    .auto_in_2_a_bits_mask     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_mask),
    .auto_in_2_a_bits_data     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_data),
    .auto_in_2_a_bits_corrupt  (auto_coupler_from_boom_tile_tl_master_clock_xing_in_a_bits_corrupt),
    .auto_in_2_b_ready         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_ready),
    .auto_in_2_b_valid         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_valid),
    .auto_in_2_b_bits_param    (auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_bits_param),
    .auto_in_2_b_bits_source   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_bits_source),
    .auto_in_2_b_bits_address  (auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_bits_address),
    .auto_in_2_c_ready         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_ready),
    .auto_in_2_c_valid         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_valid),
    .auto_in_2_c_bits_opcode   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_opcode),
    .auto_in_2_c_bits_param    (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_param),
    .auto_in_2_c_bits_size     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_size),
    .auto_in_2_c_bits_source   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_source),
    .auto_in_2_c_bits_address  (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_address),
    .auto_in_2_c_bits_data     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_data),
    .auto_in_2_c_bits_corrupt  (auto_coupler_from_boom_tile_tl_master_clock_xing_in_c_bits_corrupt),
    .auto_in_2_d_ready         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_ready),
    .auto_in_2_d_valid         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_valid),
    .auto_in_2_d_bits_opcode   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_opcode),
    .auto_in_2_d_bits_param    (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_param),
    .auto_in_2_d_bits_size     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_size),
    .auto_in_2_d_bits_source   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_source),
    .auto_in_2_d_bits_sink     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_sink),
    .auto_in_2_d_bits_denied   (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_denied),
    .auto_in_2_d_bits_data     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_data),
    .auto_in_2_d_bits_corrupt  (auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_corrupt),
    .auto_in_2_e_ready         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_e_ready),
    .auto_in_2_e_valid         (auto_coupler_from_boom_tile_tl_master_clock_xing_in_e_valid),
    .auto_in_2_e_bits_sink     (auto_coupler_from_boom_tile_tl_master_clock_xing_in_e_bits_sink),
    ...
    .auto_in_1_b_bits_source   (auto_coupler_from_rockettile_tl_master_clock_xing_in_b_bits_source),
    ...
    .auto_in_1_e_ready         (auto_coupler_from_rockettile_tl_master_clock_xing_in_e_ready),
