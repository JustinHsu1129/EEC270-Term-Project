...
module SourceB(
  ...
  assign io_b_bits_source = (_GEN[0] ? 9'h110 : 9'h0) | {_GEN[1], 8'h0};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:53:37, src/main/scala/chisel3/util/Mux.scala:30:73, :32:36]
